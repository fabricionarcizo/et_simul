function hennessey_2d_test(test_type)
%  hennessey_2d_test  Tests interpolation method
%    hennessey_2d(test_type) tests the gaze estimation method that uses 
%    linear interpolation to map the pupil-CR vector to a screen
%    position.
%
