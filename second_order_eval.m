function gaze = second_order_eval(et, camimg)
%  second_order_eval  Evaluation function for pupil-CR interpolation
...
%    <http://www.gnu.org/licenses/>.
    ...
    gaze = et.state.A * [1 pc(1) pc(2) pc(1)*pc(2) pc(1)^2 pc(2)^2 pc(1)^2*pc(2)^2]';
