function generate_simulated_data(et, observer_pos_calib, ...
    r_cornea, r_pc)
%  generate_simulated_data Generate a set of simulated eye tracking data
%    generate_simulated_data(et, observer_pos_calib, r_cornea, r_pc) tests the
%    eye tracker 'et' by sweeping the gaze position across the screen. The
%    observer position is 'observer_pos_calib' for the calibration and
%    'observer_pos_test' for the test. The size of the cornea is
