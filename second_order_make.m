function et=second_order_make()
%  second_order_make  Creates pupil-CR tracker with second-order interpolation
%    et = second_order_make() creates an eye tracker 'et' that uses biquadratic
...
%    <http://www.gnu.org/licenses/>.
    ...
    et.calib_func=@second_order_calib;
    et.eval_func=@second_order_eval;
